 ...
 * Use the {@link HomeCityFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
/*Fragment to Display Data of Home City in the Home Screen
   Key Functionalities:
   ->Display Weather Data for Home City based on Tab number from SharedPreferences
...
public class HomeCityFragment extends Fragment {
     ...
     * @return A new instance of fragment HomeCityFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static HomeCityFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_home_city, container, false);
        initialize();
        sharedPreferences = getActivity().getSharedPreferences("myFavorites", Context.MODE_PRIVATE);
        String data = sharedPreferences.getString("home", null);
        String time;
        ...
        if (data != null) {
            try {
                ...
                locationTextView.setText("Los Angeles, California");
    ...
    //Function to map Status and Image to Display for different WeatherCodes
